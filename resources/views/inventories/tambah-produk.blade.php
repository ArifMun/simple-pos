                ...
                <form action="{{ route('inventories.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        <input type="number" name="price" class="form-control" placeholder="Harga Produk"
                            aria-label="Harga Produk" aria-describedby="basic-addon1">
                        @error('price')
                        <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="input-group mb-3">
                        <input type="number" name="stock" class="form-control" placeholder="Stok Produk"
                            aria-label="Stok Produk" aria-describedby="basic-addon1">
                        @error('price')
                        <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>

                    <button type="submit" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"></i> Tambah
                    </button>
                </form>
            </div>
        </div>
